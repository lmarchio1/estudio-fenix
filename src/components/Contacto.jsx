    ...
    <section id="contacto" className="relative scroll-mt-24 overflow-hidden bg-fenixNavy-950 py-20 sm:py-28 lg:py-[129px]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          >
            <span className="flex h-12 w-12 items-center justify-center rounded-full bg-ember-400/15 icon-gold transition-transform duration-300 group-hover:scale-110">
            ...
            <span className="text-gold text-sm font-semibold">WhatsApp</span>
          ...
          >
            ...
            <span className="text-gold text-sm font-semibold">Email</span>
          ...
          <div className="group flex flex-col items-center gap-3 rounded-2xl bg-white/5 p-6 text-center ring-1 ring-inset ring-white/10 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:ring-ember-300/40 hover:shadow-lg hover:shadow-ember-900/20">
            ...
            <span className="text-gold text-sm font-semibold">Teléfono</span>
