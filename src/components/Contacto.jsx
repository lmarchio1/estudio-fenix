      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex flex-col items-center gap-2 rounded-2xl bg-white/5 px-4 py-6 text-center ring-1 ring-inset ring-white/10 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:ring-ember-300/40 hover:shadow-lg hover:shadow-ember-900/20"
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-ember-400/15 text-ember-300 transition-transform duration-300 group-hover:scale-110">
          ...
          <div className="group flex flex-col items-center gap-2 rounded-2xl bg-white/5 px-4 py-6 text-center ring-1 ring-inset ring-white/10 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:ring-ember-300/40 hover:shadow-lg hover:shadow-ember-900/20">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-ember-400/15 text-ember-300 transition-transform duration-300 group-hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" className="h-5 w-5">
