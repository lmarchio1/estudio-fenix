...
export default function Card({ icon, title, description, delay = 0 }) {
  ...
  return (
    <div
      ref={ref}
      className={`group rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-ember-200 hover:bg-white hover:shadow-xl hover:shadow-ember-900/10 ${
